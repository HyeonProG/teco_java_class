...
public class WordFinder {
	...
	public static void main(String[] args) {
			...
			while ((line = br.readLine()) != null) {
				...
				for (String word : words) {
					...
					if (!word.isEmpty()) {
						...
						// 현재 값을 가져오고 없다면 0을 반환 한다.
						// wordCountMap key 값 - String
						// wordCountMap value 값 - Integer
		...
		// 1. 공백 기준으로 단어를 잘라서 어딘가 보관해야 한다.
		// 문자열을 공백 기준으로 다룰 수 있는 기능이 존재 하는가? -> 문서, 구글링을 통해 확인
		// String line = "";

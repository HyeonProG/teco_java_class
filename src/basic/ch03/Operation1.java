...
public class Operation1 {
	...
	public static void main(String[] args) {
		...
		// 제로 포인트에서 왼쪽으로 3칸 이동한 값을 출력 하세요.
		...
		// 즉, 어떤 수에 절대값은 그 수가 양수이든 음수이든 상관없이 항상 양수.
		// 0 의 절대값은 0입니다.
		
		
		// currentPosition 값이 양수 였다면 부호연산자를 통해 변경하면 
		// 절대값이 틀려지게 됩니다.
		System.out.println(-currentPosition);
		
		// 절대값을 구하는 알고리즘을 만들어야 합니다.
		
		// Math = 자바 개발자들이 이미 만들어둔 도구입니다.
